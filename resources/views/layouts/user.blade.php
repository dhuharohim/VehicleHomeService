...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#services">Jasa Servis</a></li>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="500">
      ...
      <h3 class="text-center fst-italic">"servis kendaraan kini jauh lebih mudah"</h3>
      <div class="row">
        <div class="col text-center">
          <a href="#services" class="btn-get-started scrollto">Order Sekarang!</a>
        </div>
      </div>
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <h2>Jasa Servis</h2>
          <p>Silahkan pilih jenis Kendaraan</p>
        </div>

        <div class="row">
          <div class="col text-center" data-aos="zoom-in">
              <a href="{{ route('booking.motor') }}">
                <div class="icon-box">
                  <div class="icon">
