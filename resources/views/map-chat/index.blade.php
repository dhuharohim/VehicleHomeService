    ...
    <div class="container d-flex justify-content-center form-control shadow-sm" style="margin-top:8rem; margin-bottom:2rem;">
        <div class="row w-50">
            ...
            <div class="col">
                ...
                <h5>{{ $datas->name }}</h5>
                <h6>{{ $datas->posisi }} di {{ $datas->perusahaan }}</h6>
                <hr>
                <div class="Review-rating">
                    ...
                    <a href="{{ route('ordersum') }}" class="btn btn-danger btn-sm">Konfirmasi Pesanan Selesai</a>
                </span>
                @endforeach
            </div>
            <hr style="height: 1px; color:red;">
        ...
        <div class="col-sm-7">
            ...
            <div class="mapouter">
                <div class="gmap_canvas"><iframe width="700" height="600" id="gmap_canvas"
                        src="https://maps.google.com/maps?q=universitas%20pertamina&t=&z=15&ie=UTF8&iwloc=&output=embed"
